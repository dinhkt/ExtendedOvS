...
void abnormal_detect(struct ofproto *p)
{
    ...
    float now_recorded_n_flow;
    float now_recorded_n_bytes;
    ...
    {  
      ...
      fp=fopen("home/tuyen/ovslog/data_recording.log","a+");
      ...
      {  
        if(p->data_counter==0)
          fp=fopen("/home/tuyen/ovslog/training.log","r");
        ...
        {
          p->writing=1;
          fp=fopen("/home/tuyen/ovslog/training.log","a+");
        ...
        { 
          ...
          {
            fscanf(fp,"%f,%f",&p->flow_arr[p->data_counter],&p->traffic_arr[p->data_counter]);
            p->data_counter++;
          }
          fclose(fp);              
      ...
      else 
      {
          ...
          gettimeofday(&end, NULL);
          fp= fopen("/home/tuyen/ovslog/data_recording.log","a+");
          fprintf(fp,"%f,%lu\n",p->lof_status,end.tv_sec*1000000+end.tv_usec);
          fclose(fp);
          // fp=fopen("/home/tuyen/ovslog/time.log","a+");
