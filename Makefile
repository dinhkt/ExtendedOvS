...
sbin_PROGRAMS = $(am__EXEEXT_4) vswitchd/ovs-vswitchd$(EXEEXT) \
	ovsdb/ovsdb-server$(EXEEXT)
EXTRA_PROGRAMS = $(am__EXEEXT_1)
noinst_PROGRAMS = $(am__EXEEXT_2) tests/test-ovsdb$(EXEEXT) \
	tests/test-lib$(EXEEXT) $(am__EXEEXT_3) tests/ovstest$(EXEEXT) \
...
am__append_17 = -Wno-unused
am__append_18 = -Wno-unused-parameter
am__append_19 = \
	lib/dpif-netlink.c \
	lib/dpif-netlink.h \
...
#am__append_27 = lib/stream-ssl.c lib/dhparams.c
am__append_28 = lib/stream-nossl.c
#am__append_29 = lib/dns-resolve.c
am__append_30 = lib/dns-resolve-stub.c
...
#am__append_53 = include/openvswitch/cxxtest.cc
#am__append_54 = vswitchd/vswitch.gv vswitchd/vswitch.pic
#am__append_55 = vtep/vtep.gv vtep/vtep.pic
#am__append_56 = $(srcdir)/datapath-windows/include/OvsDpInterface.h
#am__append_57 = ovn/ovn-sb.gv ovn/ovn-sb.pic
#am__append_58 = ovn/ovn-nb.gv ovn/ovn-nb.pic
subdir = .
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	...
	$(dist_scripts_DATA) $(am__noinst_HEADERS_DIST) \
	$(openflowinclude_HEADERS) $(openvswitchinclude_HEADERS) \
	$(ovninclude_HEADERS) $(am__DIST_COMMON)
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/id-pool.c lib/id-pool.h lib/ipf.c lib/ipf.h lib/jhash.c \
	lib/jhash.h lib/json.c lib/jsonrpc.c lib/jsonrpc.h lib/lacp.c \
	lib/lacp.h lib/latch.h lib/learn.c lib/learn.h \
	...
	lib/memory.c lib/memory.h lib/meta-flow.c lib/multipath.c \
	...
	lib/netdev-linux.c lib/netdev-linux.h \
	lib/netdev-linux-private.h lib/netdev-offload-tc.c \
	lib/netlink-conntrack.c lib/netlink-conntrack.h \
	...
	lib/route-table.c lib/route-table.h lib/tc.c lib/tc.h \
	lib/netdev-afxdp-pool.c lib/netdev-afxdp-pool.h \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/dp-packet.lo lib/dpif-netdev-lookup-generic.lo \
	lib/dpif-netdev.lo lib/dpif-netdev-perf.lo lib/dpif.lo \
	lib/heap.lo lib/dynamic-string.lo lib/entropy.lo \
	lib/fat-rwlock.lo lib/fatal-signal.lo lib/flow.lo \
	lib/guarded-list.lo lib/hash.lo lib/hindex.lo lib/hmap.lo \
	lib/hmapx.lo lib/id-pool.lo lib/ipf.lo lib/jhash.lo \
	lib/json.lo lib/jsonrpc.lo lib/lacp.lo lib/learn.lo \
	lib/learning-switch.lo lib/lockfile.lo lib/mac-learning.lo \
	lib/match.lo lib/mcast-snooping.lo lib/memory.lo \
	lib/meta-flow.lo lib/multipath.lo lib/namemap.lo \
	...
	lib/ofp-ed-props.lo lib/ofp-errors.lo lib/ofp-flow.lo \
	lib/ofp-group.lo lib/ofp-ipfix.lo lib/ofp-match.lo \
	lib/ofp-meter.lo lib/ofp-monitor.lo lib/ofp-msgs.lo \
	lib/ofp-packet.lo lib/ofp-parse.lo lib/ofp-port.lo \
	lib/ofp-print.lo lib/ofp-prop.lo lib/ofp-protocol.lo \
...
am_ofproto_libofproto_la_OBJECTS =  \
	ofproto/ofproto_libofproto_la-lof.lo \
...
am_ovn_lib_libovn_la_OBJECTS = ovn/lib/acl-log.lo ovn/lib/actions.lo \
	ovn/lib/chassis-index.lo ovn/lib/expr.lo \
	ovn/lib/extend-table.lo ovn/lib/ip-mcast-index.lo \
	ovn/lib/mcast-group-index.lo ovn/lib/lex.lo \
	ovn/lib/ovn-util.lo ovn/lib/logical-fields.lo \
	ovn/lib/inc-proc-eng.lo
...
am__EXEEXT_1 = tests/oss-fuzz/flow_extract_target$(EXEEXT) \
	...
	tests/oss-fuzz/expr_parse_target$(EXEEXT) \
...
#am__EXEEXT_3 = tests/test-dpdkr$(EXEEXT)
am__EXEEXT_4 = utilities/ovs-vlan-bug-workaround$(EXEEXT)
...
am_ovn_controller_ovn_controller_OBJECTS =  \
	...
	ovn/controller/ha-chassis.$(OBJEXT) \
	ovn/controller/ip-mcast.$(OBJEXT) \
...
ovsdb_ovsdb_tool_DEPENDENCIES = ovsdb/libovsdb.la \
	lib/libopenvswitch.la
am_tests_oss_fuzz_expr_parse_target_OBJECTS =  \
	tests/oss-fuzz/expr_parse_target.$(OBJEXT)
tests_oss_fuzz_expr_parse_target_OBJECTS =  \
	$(am_tests_oss_fuzz_expr_parse_target_OBJECTS)
tests_oss_fuzz_expr_parse_target_DEPENDENCIES = lib/libopenvswitch.la \
	ovn/lib/libovn.la
tests_oss_fuzz_expr_parse_target_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(AM_CFLAGS) $(CFLAGS) \
	$(tests_oss_fuzz_expr_parse_target_LDFLAGS) $(LDFLAGS) -o $@
...
am__objects_15 = tests/test-unix-socket.$(OBJEXT)
am__objects_16 = tests/test-netlink-conntrack.$(OBJEXT)
am_tests_ovstest_OBJECTS = tests/ovstest.$(OBJEXT) \
	...
	tests/test-stopwatch.$(OBJEXT) $(am__objects_15) \
	$(am__objects_16)
...
SOURCES = $(nodist_include_openvswitch_libcxxtest_la_SOURCES) \
	...
	$(tests_ovstest_SOURCES) $(tests_test_dpdkr_SOURCES) \
	$(tests_test_lib_SOURCES) $(tests_test_ovsdb_SOURCES) \
...
am__noinst_HEADERS_DIST = AUTHORS.rst CONTRIBUTING.rst LICENSE \
	MAINTAINERS.rst README.rst NOTICE .cirrus.yml .travis.yml \
	...
	poc/playbook-ubuntu-builder.yml lib/colors.man lib/common.man \
	...
	lib/dpif-netdev-unixctl.man lib/ofp-version.man lib/ovs.tmac \
	...
	Documentation/howto/ipsec.rst Documentation/howto/kvm.rst \
	...
	Documentation/faq/ovn.rst Documentation/faq/qos.rst \
	...
	Documentation/ref/,$(RST_MANPAGES) $(RST_MANPAGES_NOINST)) \
	m4/absolute-header.m4 m4/include_next.m4 m4/pkg.m4 \
	lib/stdio.h.in lib/string.h.in lib/dh1024.pem lib/dh2048.pem \
	lib/dh4096.pem lib/common.xml lib/daemon.xml lib/dirs.c.in \
	lib/db-ctl-base.xml lib/ssl.xml lib/ssl-bootstrap.xml \
	lib/ssl-peer-ca-cert.xml lib/table.xml lib/vlog.xml \
	lib/unixctl.xml lib/vswitch-idl.ann \
	build-aux/extract-ofp-fields build-aux/extract-ofp-actions \
	build-aux/extract-ofp-errors build-aux/extract-ofp-msgs \
	lib/ovsdb-server-idl.ann lib/meta-flow.xml lib/ovs-actions.xml \
	ofproto/ipfix.xml ofproto/ipfix-enterprise-entities.def \
	utilities/ovs-sim.in utilities/gdb/ovs_gdb.py \
	...
	tests/ovs-macros.at tests/ofproto-macros.at \
	tests/ovn-macros.at tests/testsuite.at tests/completion.at \
	tests/checkpatch.at tests/library.at tests/heap.at \
	...
	tests/ovs-ofctl.at tests/fuzz-regression.at \
	tests/fuzz-regression-list.at tests/odp.at tests/mpls-xlate.at \
	...
	tests/ovsdb-server.at tests/ovsdb-client.at \
	tests/ovsdb-monitor.at tests/ovsdb-idl.at tests/ovsdb-lock.at \
	tests/ovsdb-rbac.at tests/ovs-vsctl.at tests/ovs-xapi-sync.at \
	tests/stp.at tests/rstp.at tests/interface-reconfigure.at \
	tests/vlog.at tests/vtep-ctl.at tests/auto-attach.at \
	tests/ovn.at tests/ovn-northd.at tests/ovn-nbctl.at \
	tests/ovn-sbctl.at tests/ovn-controller.at \
	tests/ovn-controller-vtep.at tests/mcast-snooping.at \
	tests/packet-type-aware.at tests/nsh.at \
	tests/ovn-performance.at tests/system-common-macros.at \
	tests/system-ovn.at tests/system-layer3-tunnels.at \
	tests/system-traffic.at tests/system-interface.at \
	tests/system-kmod-testsuite.at tests/system-kmod-macros.at \
	tests/system-userspace-testsuite.at \
	tests/system-userspace-macros.at \
	tests/system-userspace-packet-type-aware.at \
	tests/system-afxdp-testsuite.at tests/system-afxdp-macros.at \
	tests/system-offloads-traffic.at \
	tests/system-offloads-testsuite.at tests/system-dpdk-macros.at \
	tests/system-dpdk-testsuite.at tests/system-dpdk.at \
	tests/ovsdb-cluster-testsuite.at tests/ovsdb-cluster.at \
	$(srcdir)/tests/testsuite \
	$(srcdir)/tests/system-kmod-testsuite \
	$(srcdir)/tests/system-userspace-testsuite \
	$(srcdir)/tests/system-afxdp-testsuite \
	$(srcdir)/tests/system-offloads-testsuite \
	$(srcdir)/tests/system-dpdk-testsuite \
	$(srcdir)/tests/ovsdb-cluster-testsuite tests/atlocal.in \
	...
	tests/run-oftest tests/run-ryu tests/idltest.ovsschema \
	tests/idltest.ann tests/idltest2.ovsschema tests/appctl.py \
	tests/flowgen.py tests/ovsdb-monitor-sort.py \
	...
	tests/test-stream.py tests/MockXenAPI.py \
	tests/test-unix-socket.py tests/test-unixctl.py \
	tests/test-vlog.py tests/uuidfilt.py tests/sendpkt.py \
	...
	tests/oss-fuzz/config/ovs.dict tests/oss-fuzz/config/expr.dict \
	...
	ovsdb/_server.xml ovsdb/TODO.rst rhel/README.RHEL.rst \
	...
	rhel/openvswitch-fedora.spec.in rhel/ovn-fedora.spec \
	...
	python/setup.py python/ovs/_json.c python/ovs/__init__.py \
	...
	python/ovs/daemon.py python/ovs/fcntl_win.py \
	python/ovs/db/__init__.py python/ovs/db/custom_index.py \
	...
	build-aux/initial-tab-whitelist build-aux/sodepends.py \
	build-aux/soexpand.py build-aux/text2c build-aux/xml2nroff \
	include/sparse/rte_byteorder.h include/sparse/rte_esp.h \
	include/sparse/rte_flow.h include/sparse/rte_icmp.h \
	include/sparse/rte_ip.h include/sparse/rte_sctp.h \
	include/sparse/rte_tcp.h include/sparse/rte_udp.h \
	...
	include/sparse/rte_memcpy.h include/sparse/sys/socket.h \
	include/sparse/sys/sysmacros.h include/sparse/sys/types.h \
	include/sparse/sys/wait.h include/sparse/threads.h \
	...
	include/linux/pkt_cls.h include/linux/tc_act/tc_mpls.h \
...
am__DIST_COMMON = $(dist_man_MANS) $(srcdir)/Documentation/automake.mk \
	...
	$(srcdir)/ofproto/automake.mk $(srcdir)/ovn/automake.mk \
...
ACLOCAL = ${SHELL} /home/tuyen/ovs/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/tuyen/ovs/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/tuyen/ovs/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/tuyen/ovs/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/tuyen/ovs/build-aux/missing automake-1.15
AWK = mawk
CAPNG_LDADD = 
...
KARCH = 
KBUILD = /lib/modules/4.15.0-55-generic/build
...
LT_REVISION = 0
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/tuyen/ovs/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
PACKAGE_STRING = openvswitch 2.12.90
...
abs_builddir = /home/tuyen/ovs
abs_srcdir = /home/tuyen/ovs
abs_top_builddir = /home/tuyen/ovs
abs_top_srcdir = /home/tuyen/ovs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/tuyen/ovs/build-aux/install-sh
...
ALL_LOCAL = dist-hook-git config-h-check printf-check static-check \
	...
	$(am__append_51) cxx-check check-debian-changelog-version \
...
BUILT_SOURCES = ofproto/ipfix-entities.def include/odp-netlink.h \
	include/odp-netlink-macros.h $(OVSIDL_BUILT) $(am__append_56)
...
CLEANFILES = all-distfiles all-gitfiles missing-distfiles distfiles \
	...
	lib/ovs-fields.7 lib/ovs-actions.7 ofproto/ipfix-entities.def \
	...
	utilities/ovs-l3ping utilities/ovs-l3ping.8 utilities/ovs-lib \
	utilities/ovs-ofctl.8 utilities/ovs-parse-backtrace \
	utilities/ovs-pcap utilities/ovs-pcap.1 utilities/ovs-pki \
	utilities/ovs-pki.8 utilities/ovs-sim utilities/ovs-tcpdump \
	...
	$(am__append_47) include/odp-netlink.h \
	include/odp-netlink-macros.h $(am__append_50) $(am__append_53) \
	cxx-check debian/copyright ipsec/ovs-monitor-ipsec \
	vswitchd/ovs-vswitchd.8 $(am__append_54) \
	...
	vtep/vtep-ctl.8 vtep/ovs-vtep $(am__append_55) vtep/vtep.5 \
	vtep/vtep.ovsschema.stamp \
	$(srcdir)/datapath-windows/include/OvsDpInterface.h \
	$(am__append_57) ovn/ovn-sb.5 $(am__append_58) ovn/ovn-nb.5 \
	...
	ovn/utilities/ovn-detrace selinux/openvswitch-custom.te \
	selinux/openvswitch-custom.pp selinux/openvswitch-custom.fc \
...
EXTRA_DIST = AUTHORS.rst CONTRIBUTING.rst LICENSE MAINTAINERS.rst \
	README.rst NOTICE .cirrus.yml .travis.yml \
	.travis/linux-build.sh .travis/linux-prepare.sh \
	.travis/osx-build.sh .travis/osx-prepare.sh appveyor.yml \
	boot.sh poc/builders/Vagrantfile \
	poc/playbook-centos-builder.yml \
	...
	Vagrantfile Vagrantfile-FreeBSD .mailmap \
	build-aux/thread-safety-blacklist $(DOC_SOURCE) \
	m4/absolute-header.m4 m4/include_next.m4 m4/pkg.m4 \
	lib/stdio.h.in lib/string.h.in lib/dh1024.pem lib/dh2048.pem \
	lib/dh4096.pem lib/common.xml lib/daemon.xml lib/dirs.c.in \
	lib/db-ctl-base.xml lib/ssl.xml lib/ssl-bootstrap.xml \
	...
	$(SYSTEM_DPDK_TESTSUITE_AT) $(OVSDB_CLUSTER_TESTSUITE_AT) \
	$(TESTSUITE) $(SYSTEM_KMOD_TESTSUITE) \
	$(SYSTEM_USERSPACE_TESTSUITE) $(SYSTEM_AFXDP_TESTSUITE) \
	...
	tests/valgrind-wrapper.in tests/glibc.supp tests/openssl.supp \
	tests/run-oftest tests/run-ryu $(IDLTEST_IDL_FILES) \
	tests/idltest2.ovsschema $(CHECK_PYFILES) \
	tests/oss-fuzz/config/flow_extract_target.options \
	tests/oss-fuzz/config/json_parser_target.options \
	tests/oss-fuzz/config/ofp_print_target.options \
	tests/oss-fuzz/config/expr_parse_target.options \
...
bin_SCRIPTS = utilities/ovs-docker utilities/ovs-pki \
	...
	utilities/ovs-tcpundump $(am__append_32) \
	ovn/utilities/ovn-docker-overlay-driver \
	ovn/utilities/ovn-docker-underlay-driver \
...
# ovsdb-client.1
# ovsdb-server.1
man_MANS = lib/ovs-fields.7 lib/ovs-actions.7 utilities/ovs-appctl.8 \
	utilities/ovs-ctl.8 utilities/ovs-testcontroller.8 \
	utilities/ovs-dpctl.8 utilities/ovs-dpctl-top.8 \
	utilities/ovs-kmod-ctl.8 utilities/ovs-l3ping.8 \
	...
	vtep/vtep-ctl.8 vtep/vtep.5 ovn/ovn-sb.5 ovn/ovn-nb.5 \
	ovn/ovn-architecture.7 ovn/controller/ovn-controller.8 \
	ovn/controller-vtep/ovn-controller-vtep.8 \
	ovn/northd/ovn-northd.8 ovn/utilities/ovn-ctl.8 \
	ovn/utilities/ovn-nbctl.8 ovn/utilities/ovn-sbctl.8 \
	ovn/utilities/ovn-trace.8 ovn/utilities/ovn-detrace.1
MAN_FRAGMENTS = lib/colors.man lib/common.man lib/common-syn.man \
	...
	lib/netdev-dpdk-unixctl.man lib/dpif-netdev-unixctl.man \
...
noinst_HEADERS = $(EXTRA_DIST) include/sparse/rte_byteorder.h \
	include/sparse/rte_esp.h include/sparse/rte_flow.h \
	include/sparse/rte_icmp.h include/sparse/rte_ip.h \
	include/sparse/rte_sctp.h include/sparse/rte_tcp.h \
	include/sparse/rte_udp.h include/sparse/xmmintrin.h \
	include/sparse/arpa/inet.h include/sparse/bits/floatn.h \
	...
	include/sparse/rte_atomic.h include/sparse/rte_memcpy.h \
...
OVSIDL_BUILT = lib/vswitch-idl.c lib/vswitch-idl.h \
	...
	ovn/lib/ovn-sb-idl.c ovn/lib/ovn-sb-idl.h \
...
scripts_SCRIPTS = utilities/ovs-check-dead-ifs utilities/ovs-ctl \
	utilities/ovs-kmod-ctl utilities/ovs-save $(am__append_39) \
	ipsec/ovs-monitor-ipsec vtep/ovs-vtep ovn/utilities/ovn-ctl \
...
FLAKE8_PYFILES = Documentation/conf.py ofproto/ipfix-gen-entities \
	...
	utilities/ovs-dev.py utilities/ovs-tcpdump.in \
	utilities/ovs-pipegen.py $(am__append_40) $(CHECK_PYFILES) \
...
lib_libopenvswitch_la_SOURCES = lib/aes128.c lib/aes128.h \
	...
	lib/lldp/lldp-tlv.h lib/lldp/lldpd.c lib/lldp/lldpd.h \
	lib/lldp/lldpd-structs.c lib/lldp/lldpd-structs.h \
	$(am__append_15) $(am__append_16) $(am__append_19) \
	$(am__append_20) $(am__append_21) $(am__append_22) \
	$(am__append_23) $(am__append_24) $(am__append_25) \
	$(am__append_26) $(am__append_27) $(am__append_28) \
	lib/dns-resolve.h $(am__append_29) $(am__append_30)
nodist_lib_libopenvswitch_la_SOURCES = \
	lib/dirs.c \
...
lib_libsflow_la_CFLAGS = $(AM_CFLAGS) $(am__append_17) \
	$(am__append_18)
...
ofproto_libofproto_la_SOURCES = ofproto/lof.h ofproto/lof.c \
	ofproto/bond.c ofproto/bond.h ofproto/collectors.c \
	ofproto/collectors.h ofproto/connmgr.c ofproto/connmgr.h \
	ofproto/fail-open.c ofproto/fail-open.h ofproto/in-band.c \
	ofproto/in-band.h ofproto/names.c ofproto/netflow.c \
	ofproto/netflow.h ofproto/ofproto.c ofproto/ofproto.h \
	ofproto/ofproto-dpif.c ofproto/ofproto-dpif.h \
...
tests_ovstest_SOURCES = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-stp.c tests/test-unixctl.c tests/test-util.c \
	tests/test-uuid.c tests/test-bitmap.c tests/test-vconn.c \
	tests/test-aa.c tests/test-stopwatch.c $(am__append_44) \
	$(am__append_45)
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/tests/oss-fuzz/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/ovn/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/include/linux/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/ipsec/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/ovn/utilities/bugtool/automake.mk $(srcdir)/selinux/automake.mk $(srcdir)/build-aux/automake.mk $(am__configure_deps)
	@for dep in $?; do \
...
ofproto/$(DEPDIR)/$(am__dirstamp):
	...
	@: > ofproto/$(DEPDIR)/$(am__dirstamp)
ofproto/ofproto_libofproto_la-lof.lo: ofproto/$(am__dirstamp) \
	ofproto/$(DEPDIR)/$(am__dirstamp)
...
ovn/lib/expr.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/extend-table.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/ip-mcast-index.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/mcast-group-index.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
...
ovn/lib/logical-fields.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/inc-proc-eng.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
...
ovn/controller/encaps.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/ha-chassis.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/ip-mcast.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
...
tests/oss-fuzz/expr_parse_target$(EXEEXT): $(tests_oss_fuzz_expr_parse_target_OBJECTS) $(tests_oss_fuzz_expr_parse_target_DEPENDENCIES) $(EXTRA_tests_oss_fuzz_expr_parse_target_DEPENDENCIES) tests/oss-fuzz/$(am__dirstamp)
	@rm -f tests/oss-fuzz/expr_parse_target$(EXEEXT)
	$(AM_V_CCLD)$(tests_oss_fuzz_expr_parse_target_LINK) $(tests_oss_fuzz_expr_parse_target_OBJECTS) $(tests_oss_fuzz_expr_parse_target_LDADD) $(LIBS)
tests/oss-fuzz/flow_extract_target.$(OBJEXT):  \
	tests/oss-fuzz/$(am__dirstamp) \
	tests/oss-fuzz/$(DEPDIR)/$(am__dirstamp)
...
include ofproto/$(DEPDIR)/ofproto_libofproto_la-lof.Plo
...
include ovn/controller/$(DEPDIR)/ha-chassis.Po
include ovn/controller/$(DEPDIR)/ip-mcast.Po
...
include ovn/lib/$(DEPDIR)/extend-table.Plo
include ovn/lib/$(DEPDIR)/inc-proc-eng.Plo
include ovn/lib/$(DEPDIR)/ip-mcast-index.Plo
include ovn/lib/$(DEPDIR)/lex.Plo
include ovn/lib/$(DEPDIR)/logical-fields.Plo
include ovn/lib/$(DEPDIR)/mcast-group-index.Plo
...
include tests/oss-fuzz/$(DEPDIR)/expr_parse_target.Po
...
ofproto/ofproto_libofproto_la-lof.lo: ofproto/lof.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(ofproto_libofproto_la_CPPFLAGS) $(CPPFLAGS) $(ofproto_libofproto_la_CFLAGS) $(CFLAGS) -MT ofproto/ofproto_libofproto_la-lof.lo -MD -MP -MF ofproto/$(DEPDIR)/ofproto_libofproto_la-lof.Tpo -c -o ofproto/ofproto_libofproto_la-lof.lo `test -f 'ofproto/lof.c' || echo '$(srcdir)/'`ofproto/lof.c
	$(AM_V_at)$(am__mv) ofproto/$(DEPDIR)/ofproto_libofproto_la-lof.Tpo ofproto/$(DEPDIR)/ofproto_libofproto_la-lof.Plo
#	$(AM_V_CC)source='ofproto/lof.c' object='ofproto/ofproto_libofproto_la-lof.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(ofproto_libofproto_la_CPPFLAGS) $(CPPFLAGS) $(ofproto_libofproto_la_CFLAGS) $(CFLAGS) -c -o ofproto/ofproto_libofproto_la-lof.lo `test -f 'ofproto/lof.c' || echo '$(srcdir)/'`ofproto/lof.c
...
distclean: distclean-recursive
	...
	-rm -rf include/openvswitch/$(DEPDIR) lib/$(DEPDIR) lib/lldp/$(DEPDIR) ofproto/$(DEPDIR) ovn/controller-vtep/$(DEPDIR) ovn/controller/$(DEPDIR) ovn/lib/$(DEPDIR) ovn/northd/$(DEPDIR) ovn/utilities/$(DEPDIR) ovsdb/$(DEPDIR) tests/$(DEPDIR) tests/dpdk/$(DEPDIR) tests/oss-fuzz/$(DEPDIR) utilities/$(DEPDIR) vswitchd/$(DEPDIR) vtep/$(DEPDIR)
	-rm -f Makefile
