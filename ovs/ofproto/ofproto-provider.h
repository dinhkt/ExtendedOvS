...
struct ofproto {
    ...
    int writing;    /*check whether write to training file*/
    int training;   /*in training time or not*/
    float last_recorded_n_flow;
    float last_recorded_n_bytes;
    float *traffic_arr;  /*array store the traffic data for calculating lof*/
    float *flow_arr;     /*array store the flow data for calculating lof*/
    
    data_t *state;  /*status of current (traffic,new flow)*/
    data_t *Data[DATANUM]; /*store the lrd of all training data*/
    long last_time;
    int data_counter;
    float lof_status;
    float flow_mu;       
